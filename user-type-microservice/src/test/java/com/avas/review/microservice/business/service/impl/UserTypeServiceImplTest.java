...
import com.avas.review.microservice.business.mappers.UserTypeMapper;
import com.avas.review.microservice.business.repository.UserTypeRepository;
...
import static com.avas.review.microservice.test.data.UserTypeTestData.createUserTypeDto;
import static com.avas.review.microservice.test.data.UserTypeTestData.createUserTypeDtoList;
...
public class UserTypeServiceImplTest {
    ...
    public void createTestData() {
        this.userTypeDTO = createUserTypeDto();
    ...
    public void testUserTypesSuccessfully() {
        List<UserTypeDTO> userTypeDtoList = createUserTypeDtoList();
