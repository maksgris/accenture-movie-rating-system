...
import com.avas.review.microservice.business.mappers.MovieTypeMapping;
import com.avas.review.microservice.business.repository.MovieTypeRepository;
...
import static com.avas.review.microservice.test.data.MovieTypeTestData.createMovieTypeDto;
import static com.avas.review.microservice.test.data.MovieTypeTestData.createMovieTypeDtoList;
...
public class MovieTypeImplTest {
    ...
    public void createTestData() {
        this.movieTypeDTO = createMovieTypeDto();
    ...
    public void testMovieTypeSuccessfully() {
        List<MovieTypeDTO> userDtoList = createMovieTypeDtoList();
